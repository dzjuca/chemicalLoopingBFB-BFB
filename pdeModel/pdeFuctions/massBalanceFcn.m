function u_t = massBalanceFcn(gs, estructC, Tbe, alpha, u, db, ...
                              reactorType, Global, id_1, id_2, id_3)
% -------------------------------------------------------------------------
    % massBalanceFcn 
    % ----------------------------| input |--------------------------------
...
% -------------------------------------------------------------------------
    ...
    if strcmp(id_1,'FGBurbuja')
        ...
        u_t = -(mbrhs1Fcn(alpha, u, g_b, reactorType,                   ... 
                          Global, id_1)).*FC1                           ...
              +(mbrhs2Fcn(alpha, u, g_b, g_e, reactorType,              ...
                          Global, id_2)).*FC1                           ... 
              -(mbrhs3Fcn(alpha, db, u, g_b, g_e, C_g, Tbe,             ...
                          reactorType, Global, id_2, id_3)).*FC1        ...
              +(mbrhs4Fcn(alpha, estructC, Tbe, reactorType,            ...
                          Global, id_1, id_3)).*FC1;
...
% -------------------------------------------------------------------------
    ...
    elseif strcmp(id_1,'FGEmulsion')
        ...
        u_t = -(mbrhs1Fcn(alpha, u(:,2), g_e, reactorType,              ...
                          Global, id_1)).*FC2                           ...
              -(mbrhs2Fcn(alpha, u(:,1), g_b, g_e, reactorType,         ...
                          Global, id_2)).*FC2                           ...
              +(mbrhs3Fcn(alpha, db, u(:,1), g_b, g_e, C_g, Tbe,        ...
                          reactorType, Global, id_2, id_3)).*FC2        ...
              +(mbrhs4Fcn(alpha, estructC, Tbe, reactorType,            ...
                          Global, id_1, id_3)).*FC2;
...
% -------------------------------------------------------------------------
    ...
    elseif strcmp(id_1,'FSEstela')
        ...
        u_t = -mbrhs1Fcn(alpha, u, s_w, reactorType,                    ...
                         Global, id_1).*FC3                             ...
              +mbrhs2Fcn(alpha, u, s_w, s_e, reactorType,               ...
                         Global, id_2).*FC3                             ...
              -mbrhs3Fcn(alpha, db, [], s_w, s_e, [], [],               ...
                         reactorType, Global, id_2, []).*FC3            ...
              +mbrhs4Fcn(alpha, estructC, Tbe, reactorType,             ...
                         Global, id_1, id_3).*FC3;
...
% -------------------------------------------------------------------------
    ...
    elseif strcmp(id_1,'FSEmulsion')
        ...
        u_t = +mbrhs1Fcn(alpha, u(:,2), s_e, reactorType,               ...
                         Global, id_1).*FC4                             ...
              -mbrhs2Fcn(alpha, u(:,1), s_w, s_e, reactorType,          ...
                         Global, id_2).*FC4                             ... 
              +mbrhs3Fcn(alpha, db, [], s_w, s_e, [], [],               ...
                         reactorType, Global, id_2, []).*FC4            ...
              +mbrhs4Fcn(alpha, estructC, Tbe, reactorType,             ...
                         Global, id_1, id_3).*FC4;
